...
declare global
{
    namespace NodeJS
    {
        export interface ProcessEnv
        {
            ...
            NEW_ORDER_EXPIRATION_TIME_HOURS?: string;
            FAILED_ORDER_EXPIRATION_TIME_HOURS?: string;
            EXECUTING_ORDER_EXPIRATION_TIME_HOURS?: string;
            EXECUTED_ORDER_EXPIRATION_TIME_HOURS?: string;
            CLOSED_POSITION_EXPIRATION_TIME_HOURS?: string;
        }
    }
}
...
const config = {
    ...
    NEW_ORDER_EXPIRATION_TIME_HOURS: process.env.NEW_ORDER_EXPIRATION_TIME_HOURS ?? "1",
    FAILED_ORDER_EXPIRATION_TIME_HOURS: process.env.FAILED_ORDER_EXPIRATION_TIME_HOURS ?? "48",
    EXECUTING_ORDER_EXPIRATION_TIME_HOURS: process.env.EXECUTING_ORDER_EXPIRATION_TIME_HOURS ?? "1",
    EXECUTED_ORDER_EXPIRATION_TIME_HOURS: process.env.EXECUTED_ORDER_EXPIRATION_TIME_HOURS ?? "720",
    CLOSED_POSITION_EXPIRATION_TIME_HOURS: process.env.CLOSED_POSITION_EXPIRATION_TIME_HOURS ?? "720",
};
